...
def main(hparams) -> None:
    ...
    # ------------------------
    # 1 INIT LIGHnum_labelsTNING MODEL
    # ------------------------
    ...
    # ------------------------
    early_stop_callback = EarlyStopping(monitor=hparams.monitor,
                                        min_delta=0.0,
    ...
    # 3 INIT TRAINER
    # ------------------------
    trainer = Trainer(logger=setup_testube_logger(),
